...
export default function Calculator() {
    ...
    return (
        <div className="container mx-auto max-w-2xl shadow-xl rounded-md border-gray-100 border-2 my-4 pt-4" style={{minHeight:'400px'}}>
            ...
            <div className="input-container">
                <div className="mode-switcher-container text-center flex flex-row w-full">
                    <ModeSelect active={mode === 0} className="monthly-mode-container flex-grow py-3" onClick={e=>setMode(0)}>
                        Monthly Payment
                    </ModeSelect>
                    <ModeSelect active={mode === 1} className="max-cost-mode-container flex-grow py-3" onClick={e=>setMode(1)}>
                        Maximum Price
                    </ModeSelect>
                </div>
                <div className="calculator-content bg-gray-100">
                    {
                        mode === 0 ? 
